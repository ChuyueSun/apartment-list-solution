...
#   from lower length to higher length add edges between names with length difference 1    
    for length in word_dic:       
...
def bfs(g, start): 
    '''
    input: g: the graph for social network of the names
           start: position of the name wanted to be searched
    output: the size of the social network for the name wanted to be searched
    '''
    count = 1
    start.setColor('grey')
...
def count_friends(filename,name_to_search):
    '''
    input: filename: txt of the names
           name_to_search: string of the name wanted to be searched
    output: the size of the social network for name_to_search
    '''
